  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        backdrop
        positionClass="fixed left-1/2 top-16 -translate-x-1/2 sm:absolute sm:right-[6%] sm:left-auto sm:top-auto sm:translate-x-0 lg:right-0"
        className="w-[95vw] max-w-[350px] h-[480px] mt-0 flex flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:w-[90vw] md:w-[80vw] lg:w-[350px]"
      >
